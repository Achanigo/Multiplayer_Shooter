...
namespace Shooter
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            UpdatePorParser(cliente.gameInformation);
        ...
        private void UpdatePlayer2(GameTime gameTime)
        {
            ...
            if (player2.Active)
            {
                ...
                {
                    cliente.message += "|IZQUIERDA";
                }
                if (currentKeyboardState.IsKeyDown(Keys.D))
                {
                    cliente.message += "|DERECHA";
                }
                if (currentKeyboardState.IsKeyDown(Keys.W))
                {
                    cliente.message += "|ARRIBA";
                }
                if (currentKeyboardState.IsKeyDown(Keys.S))
                {
                    cliente.message += "|ABAJO";
                }
                if (currentKeyboardState.IsKeyDown(Keys.P))
                {
                    cliente.message += "|DISPARO";
                }
                ...
                if (!string.IsNullOrEmpty(p1))
                {
                    ...
                    if (balas1 != "")
                    {
                        for (int i = 0; i < arr.Length; i++)
                        {
                            ...
                            Projectile projectile = new Projectile();
                            projectile.Initialize(GraphicsDevice.Viewport, projectileTexture, new Vector2(Convert.ToInt32(tmp[0]), Convert.ToInt32(tmp[1])), 1);
